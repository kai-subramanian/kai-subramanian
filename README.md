...
***August 2022 to May 2023*** (Bangalore) <br> Interned at Intel Corporation, in the NCNG Ethernet SW team. Built a debugger library in C++, to provide the debug information in DWARF format. <br>T his library was later shipped to a Fortune 100 company. Personal contribution - Created the common C++ class for representing the debug information, and reduced code duplication.
